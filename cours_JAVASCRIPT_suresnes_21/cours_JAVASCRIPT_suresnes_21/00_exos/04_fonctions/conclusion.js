...
para1.addEventListener('click',function() {// sur cette variable je rajoute un écouteur d'évènement avec, au clique, une fonction anonyme qui s'exécute à la demande
...
para2.addEventListener ('dblclick', function(){
    alert('Et là un double cliqe sur le paragraphe.')
});
